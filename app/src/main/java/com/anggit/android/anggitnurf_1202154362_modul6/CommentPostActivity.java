...
import com.anggit.android.anggitnurf_1202154362_modul6.adapter.CommentAdapter;
import com.anggit.android.anggitnurf_1202154362_modul6.model.Comment;
import com.anggit.android.anggitnurf_1202154362_modul6.model.User;
...
public class CommentPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseComments = FirebaseDatabase.getInstance().getReference(Home.table_2).child(id);
        databaseUser = FirebaseDatabase.getInstance().getReference(Home.table_3);
